...
# baslangic = int(input("Baslangıç değeri : "))
...
# 5: Kullanıcıdan alacağınız sınırsız ürün bilgisini ürünler listesi içinde saklayarak
...
adet = int(input("kaç ürün eklemek istiorsunuz : "))
